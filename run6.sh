...
image_dir=/home/vcla/Sites/vtt/demo/static/data/new/oriFrameFolder/unparking_view-HC2
results_dir=/home/vcla/Sites/vtt/demo/static/data/new/oriPoseFolder/unparking_view-HC2/POSE
render_dir=/home/vcla/Sites/vtt/demo/static/data/new/dstPoseFolder/unparking_view-HC2
python tracker-general.py --imgdir ${image_dir}  \
                          --in_json ${results_dir}/alpha-pose-results.json \
                          --out_json ${results_dir}/alpha-pose-results-forvis-tracked.json \
                          --visdir ${render_dir}
