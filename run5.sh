...
image_dir=/home/vcla/Sites/vtt/demo/static/data/new/oriFrameFolder/suspect-look_view-GL6
results_dir=/home/vcla/Sites/vtt/demo/static/data/new/oriPoseFolder/suspect-look_view-GL6/POSE
render_dir=/home/vcla/Sites/vtt/demo/static/data/new/dstPoseFolder/suspect-look_view-GL6
python tracker-general.py --imgdir ${image_dir}  \
                          --in_json ${results_dir}/alpha-pose-results.json \
                          --out_json ${results_dir}/alpha-pose-results-forvis-tracked.json \
                          --visdir ${render_dir}
